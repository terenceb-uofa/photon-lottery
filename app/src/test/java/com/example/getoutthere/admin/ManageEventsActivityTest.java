...
public class ManageEventsActivityTest {
    ...
    private Event makeEvent(String id, String name, String organizerId, String status) {
    ...
    public void testGrabData_populatesEventList_onSuccess() {
        Event event1 = makeEvent("id1", "Trail Hike", "org1", "Open");
        Event event2 = makeEvent("id2", "Beach Cleanup", "org2", "Closed");

        // Simulate grabData() success: clear then add non-null events
     ...
     * the event is removed from the local list.
     */
    @Test
